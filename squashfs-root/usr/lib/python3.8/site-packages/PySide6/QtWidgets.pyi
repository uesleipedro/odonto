...
class QFontDialog(PySide6.QtWidgets.QDialog):
    ...
    @overload
    @staticmethod
    def getFont(initial:Union[PySide6.QtGui.QFont, str, Sequence[str]], parent:Optional[PySide6.QtWidgets.QWidget]=..., title:str=..., options:PySide6.QtWidgets.QFontDialog.FontDialogOptions=...) -> Tuple[bool, Tuple]: ...
    @overload
    @staticmethod
